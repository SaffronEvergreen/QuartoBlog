...
*Update*\
I reviewed my notes and have reached a conclusion on how to determine a given margin of error.\
\@ having a margin of error that is used in other relevant studies is important as it makes the statistics more reliable and more comparable/reproducible.\
\@ a smaller margin of error is more ideal when "risk" is high - when making reproducible reports, it might be beneficial to have 2-3 different margins of errors in the calculations to compare/contrast for future research projects.

**Determining your margin of error**

-   large samples (discretion is advised) can have smaller margins of errors given that the samples are more representative of the population. It will be important to make sure that the demographics and distribution of variables in the sample population are representative of the study population (i.e., check census data)\
-   a higher confidence interval requires a larger margin of error - decipher accordingly\
-   example: if you are testing the validity of the datasets accuracy and the estimate is 96% with a margin of error being 4% (with a 95% confidence interval), then the concluding generalizable statement would be something like;

> Given that the accuracy of the data is 96%, there is 95% confidence that the population estimates would fall between 92% to 100%
