...
**Explanation**:\
Accuracy is 100%. The validation dataset is small (20%) but is within our expected margin of $97\% ~\pm~4\%$. Concluding that we *might* have an accurate and a reliably accurate model.
